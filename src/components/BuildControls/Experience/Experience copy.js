                ...
                formElementsArray.map((formElement, index) => (
                  <Aux key={formElement.id}>
                    ...
                    <div className="row col-lg-10 mx-auto">
                      <div className="col-lg-12 text-left"><h3><b><i className="fas fa-check-circle mr-1"></i>{index + 1}</b></h3><hr/></div>
                  ...
                  <div className="container text-center">
                    ...
                    <button type="submit" className="btn btn-info" onClick={props.addEl}>Add<i className="fas fa-angle-right ml-1"></i></button>
                  </div>
                  <br/>
                </form>
              </div>
